...
void MaterialUI::render_update()
{
	...
	for (size_t i = 0; i < (UINT)SCALAR_PARAM::END; ++i)
	{
		...
		case SCALAR_PARAM::BOOL_3:
			ParamUI::Param_BOOL((bool*)m_TargetMtrl->GetScalarParam(vecScalarParam[i].Type), vecScalarParam[i].Desc,
								vecScalarParam[i].View, vecScalarParam[i].Tooltip);
			break;
		case SCALAR_PARAM::INT_0:
		case SCALAR_PARAM::INT_1:
		case SCALAR_PARAM::INT_2:
		case SCALAR_PARAM::INT_3:
			ParamUI::Param_INT((int*)m_TargetMtrl->GetScalarParam(vecScalarParam[i].Type), vecScalarParam[i].Desc,
							   (int)vecScalarParam[i].Min, (int)vecScalarParam[i].Max, vecScalarParam[i].View,
							   vecScalarParam[i].Tooltip);
			break;
		case SCALAR_PARAM::FLOAT_0:
		case SCALAR_PARAM::FLOAT_1:
		case SCALAR_PARAM::FLOAT_2:
		case SCALAR_PARAM::FLOAT_3:
			ParamUI::Param_FLOAT((float*)m_TargetMtrl->GetScalarParam(vecScalarParam[i].Type), vecScalarParam[i].Desc,
								 vecScalarParam[i].Min, vecScalarParam[i].Max, vecScalarParam[i].View,
								 vecScalarParam[i].Tooltip);
			break;
		...
		case SCALAR_PARAM::VEC2_3:
			ParamUI::Param_VEC2((Vec2*)m_TargetMtrl->GetScalarParam(vecScalarParam[i].Type), vecScalarParam[i].Desc,
								vecScalarParam[i].Min, vecScalarParam[i].Max, vecScalarParam[i].View,
								vecScalarParam[i].Tooltip);
			break;
		...
		case SCALAR_PARAM::VEC4_3:
			ParamUI::Param_VEC4((Vec4*)m_TargetMtrl->GetScalarParam(vecScalarParam[i].Type), vecScalarParam[i].Desc,
								vecScalarParam[i].Min, vecScalarParam[i].Max, vecScalarParam[i].View,
								vecScalarParam[i].Tooltip);
			break;
