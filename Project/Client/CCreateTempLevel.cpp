...
void CCreateTempLevel::CreateTempLevel()
{
	...
	pObj->MeshRender()->GetMaterial()->SetScalarParam(SCALAR_PARAM::INT_0, 0);
	...
	pObj->MeshRender()->GetMaterial()->SetTexParam(TEX_PARAM::TEX_2, CAssetMgr::GetInst()->Load<CTexture>(L"texture\\tile\\TILE_02.tga"));
	pObj->MeshRender()->GetMaterial()->SetTexParam(TEX_PARAM::TEX_3, CAssetMgr::GetInst()->Load<CTexture>(L"texture\\tile\\TILE_02_N.tga"));
