...
#define UseUVSplitRender    g_bool_3
#define SplitRenderCount    g_int_0
...
[maxvertexcount(6)]
void GS_DynamicHP(point VS_OUT _in[1], inout TriangleStream<GS_OUT> _OutStream)
{
...
float4 PS_DynamicHP(GS_OUT _in) : SV_Target
{
    // 출력 색상
