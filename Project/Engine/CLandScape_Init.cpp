...
void CLandScape::Init()
{
	...
	// L"texture\\tile\\TILE_ARRR.dds"); m_TileArrTex =
	// CAssetMgr::GetInst()->LoadTexture(L"texture\\tile\\TILE_ARRR.dds", L"texture\\tile\\TILE_ARRR.dds", 8);
	m_TileArrTex = CAssetMgr::GetInst()->Load<CTexture>(L"texture\\tile\\TILE_ARRR.dds");
...
void CLandScape::CreateTexture()
{
	...
	{
		m_HeightMapTex = CAssetMgr::GetInst()->CreateTexture(L"HeightMapTex", 2048, 2048, DXGI_FORMAT_R32_FLOAT,
